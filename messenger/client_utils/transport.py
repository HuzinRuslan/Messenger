...
from common.vars import ACTION, PRESENCE, RESPONSE, ERROR, TIME, USER, ACCOUNT_NAME, \
    SENDER, MESSAGE, MESSAGE_TEXT, DESTINATION, EXIT, GET_CONTACTS, LIST_INFO, REMOVE_CONTACT, \
    ADD_CONTACT, USERS_REQUEST, PUBLIC_KEY, DATA, RESPONSE_511
...
class ClientTransport(threading.Thread, QObject):
    ...
    def run(self):
        ...
        while self.running:
            ...
            # если не сделать тут задержку, то отправка может достаточно долго ждать
            # освобождения сокета.
            time.sleep(1)
            with socket_lock:
                try:
